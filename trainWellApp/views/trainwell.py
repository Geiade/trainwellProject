...
def index(request):
    ...
    context = {'events': [('Football', 'Football field with natural grass. Regulatory measures',
                          ...
                          ('Handball', 'Indoor handball court. Multipurpose court. ',
                          ...
                          ('Fitness', 'Exercise you in our three fitness room. Full-equiped',
                           '#9575cd', media_url + 'fitness.jpg'),
                          ('Swimming', 'Indoor swiming pool. Regulatory measures',
                           '#90caf9', media_url + 'swimming_pool.jpg'),
                          ('Hockey', 'Indoor field for hockey. Multipurpose court',
                           '#b3e5fc', media_url + 'hockey.jpg'),
                          ('Skating', 'Indoor field for skating. Multipurpose court',
